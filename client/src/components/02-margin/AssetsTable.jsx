...
export default function AssetsTable() {
  ...
  const [orderBy, setOrderBy] = React.useState("netAsset");
  ...
  const emptyRows =
    page > 0 ? Math.max(0, (1 + page) * rowsPerPage - userAssets.length) : 0;

  const visibleRows = React.useMemo(
    () =>
      stableSort(userAssets, getComparator(order, orderBy)).slice(
        page * rowsPerPage,
